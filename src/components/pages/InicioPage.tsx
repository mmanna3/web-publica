...
import { BASE_URL, TORNEOS_PORTAL_URL } from '../../globalConst';
  ...
  return (
    <>
      ...
      <div className=' mx-auto flex flex-col items-center gap-6 p-16 xs:max-w-sm md:max-w-md xl:max-w-xl'>
        <ImageBtn img={IMG_BTN_TORNEOS} alt='torneos' url={TORNEOS_PORTAL_URL} />
        <ImageBtn img={IMG_BTN_COPAS} alt='copas' url={TORNEOS_PORTAL_URL} />
